...
class GPT(nn.Module):
    def __init__(self, head_num, size_per_head, vocab_size, start_id, end_id, layer_num, top_k, top_p, temperature,
                 output_len, max_seq_len, tensor_para_size, layer_para_size, layer_para_batch_size, is_fuse_QKV, max_batch_size, repetition_penalty, lib_path):
        super().__init__()
        self.head_num = head_num
        self.size_per_head = size_per_head
        self.vocab_size = vocab_size
    ...
    def cuda(self):
        ...
        self.model = torch.classes.FasterTransformer.GPT(self.head_num, self.size_per_head, self.vocab_size,
                                                        ...
                                                        self.is_fuse_QKV, self.max_batch_size, self.repetition_penalty, *self.weights.w)
